...
function Cards(props) {
    ...
    if (!data) {
        ...
        return <div className="text-slate-200 mt-[5rem] text-lg font-bold" >API is Paid hence can`t display news on live site.</div>
    }
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-8' >
            {
                data.map((item, index) => {
                    if (!item) {
                        ...
                        return <div className='text-slate-200 mt-[5rem] text-lg font-bold ' >No Data</div>
                    }
                    return (
